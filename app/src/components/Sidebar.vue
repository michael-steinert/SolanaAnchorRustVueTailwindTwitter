...
<!-- The Sidebar Component is used in the `App.vue` Main Component and designs the Sidebar on the Left of the App -->
<!-- It uses the `<router-link>` Component to easily generate Vue Router URLs -->
<!-- It also contains a Button for Users to connect their Wallets -->
<template>
